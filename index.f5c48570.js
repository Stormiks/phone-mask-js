...
var _indexJs = require("./plugin/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
document.addEventListener("DOMContentLoaded", function() {
    const InputMask = new (0, _indexJsDefault.default)();
    console.info("Install to lib", InputMask._libName);
    document.querySelector("input").focus();
});

},{"./plugin/index.js":"eCz5k","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eCz5k":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class InputTelephon {
    ...
    constructor(options = {}){
        ...
        if (this.isInitInstance) this.install();
    }
    set _inputs($nodes = []) {
        this.#_inputs = $nodes;
    }
    ...
    install() {
        if (!this._inputs.length) this._inputs = document.querySelectorAll(this._searchInputPattern);
        if (this._inputs.length) this.subscribeEventsOnTheInput();
    }
    ...
    handlerKeydown(e) {
        ...
        if (e.keyCode === 8 && $fieldValue.length === 1) e.target.value = "";
    }
    handlerFocus(e) {
    ...
    handlerInput(e) {
        ...
        if ($field.value.length != selectionStart) {
            if (e.data && this.maskField.test(e.data)) $field.value = inputNumbersValue;
            return;
        }
        if ([
            "7",
    ...
    getMethodAtInstance(nameEvent) {
        ...
        if (!this[nameMethodAtClass]) return false;
        else return this[nameMethodAtClass];
    }
    subscribeEventsOnTheInput() {
        for (const $input of this._inputs){
            ...
            for (const event of this._eventsInput){
                ...
                if (typeof handlerMethod === "function") $input.addEventListener(event, handlerMethod.bind(this), false);
            }
        }
    }
}
exports.default = InputTelephon;
...
},{}]},["4qavH","8ZNvh"], "8ZNvh", "parcelRequire7a31")
